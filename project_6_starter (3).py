...
freqs = {word: count / number_messages for word, count in bow.items()}

# Float that is the frequency cutoff. Drop words with a frequency that is lower or equal to this number.
low_cutoff = 0.00000002
...
id2vocab = {key_rev: word for word, key_rev in vocab.items()}
